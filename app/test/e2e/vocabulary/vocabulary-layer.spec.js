...
describe('Vocabulary-layer relationships test suite', () => {
    ...
    it('Getting vocabulary-layer relationships without auth returns 401 Unauthorized', async () => {
    ...
    it('Getting vocabulary-layer relationships with auth returns 200 OK with the requested data', async () => {
